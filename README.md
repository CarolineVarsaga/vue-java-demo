...
![Dashboard view](client/src/assets/vue-java-dashboard.png)
The employee table with sorting functions and pagination.
![Employee table](client/src/assets/vue-java-table.png)
The look when it's sorted.
![Employee table sorted](client/src/assets/vue-java-sort.png)
When an employee is set as a favorite, it will land at the top of the table.
![Employee table fav](client/src/assets/vue-java-fav.png)
